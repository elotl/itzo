...
itzo-arm: $(PKG_SRC) $(ITZO_SRC) go.mod go.sum
	GOOS=linux GOARCH=arm $(GO_BIN) build $(LDFLAGS) -tags containers_image_openpgp -o $(TOP_DIR)itzo-arm $(TOP_DIR)cmd/itzo
